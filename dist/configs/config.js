...
const config = {
    ...
    outerluis: {
        ...
        UniversityRelocation: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_UNIVERSITYRELOCATION_APP_ID + POST_LUIS_LINK,
        },
        RewardsAndRecognition: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_REWARDSANDRECOGNITION_APP_ID + POST_LUIS_LINK,
        },
        Gym_Guidelines: {
        ...
        MobileAndInternet: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_MOBILEANDINTERNET_APP_ID + POST_LUIS_LINK,
        },
        Gratuity: {
        ...
        UnreportedAbsenteeism: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_UNREPORTEDABSENTEEISM_APP_ID + POST_LUIS_LINK,
        },
        Discrimination: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_DISCRIMINATION_APP_ID + POST_LUIS_LINK,
        },
        IJP: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_IJP_APP_ID + POST_LUIS_LINK,
        },
        AlcoholDrug: {
        ...
        AssociateAssistance: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_ASSOCIATEASSISTANCE_APP_ID + POST_LUIS_LINK,
        },
        ViolenceFree: {
        ...
        Tax_and_Payroll_Investment_Dec: {
            LuisEndpoint: PRE_LUIS_LINK +
                process.env.LUIS_TAX_AND_PAYROLL_INVESTMENT_DEC_APP_ID +
                POST_LUIS_LINK,
        },
        Tax_and_Payroll_CTC: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_CTC_APP_ID + POST_LUIS_LINK,
        },
        Tax_and_Payroll_Medical: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_MEDICAL_APP_ID + POST_LUIS_LINK,
        },
        Tax_and_Payroll_IPSF: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_IPSF_APP_ID + POST_LUIS_LINK,
        },
        ...
        Tax_and_Payroll_Form_16: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_FORM_16_APP_ID + POST_LUIS_LINK,
        },
        Tax_and_Payroll_80C: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_80C_APP_ID + POST_LUIS_LINK,
        },
        ...
        Tax_and_Payroll_HRA: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_HRA_APP_ID + POST_LUIS_LINK,
        },
        Tax_and_Payroll_PPF_PF_VPF: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_PPF_PF_VPF_APP_ID + POST_LUIS_LINK,
        },
        Tax_and_Payroll_LTA: {
            LuisEndpoint: PRE_LUIS_LINK + process.env.LUIS_TAX_AND_PAYROLL_LTA_APP_ID + POST_LUIS_LINK,
        },
        HR_Mart_Module: {
    ...
    hrmart: {
        ...
        GETMANAGERCANCELPENDINGAPPROVALS: process.env.HRMART_GET_MANAGER_CANCEL_PENDING_APPROVALS_PASSWORD,
