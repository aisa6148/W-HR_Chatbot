...
exports.POLICY_ARRAY = exports.MAILER = exports.GREETING_BUTTONS_NOTIFICATIONS = exports.SHOW_MORE = exports.GREETING_BUTTONS = exports.BYOD_AD_SERVICE_NOW = exports.LEAVE_MANAGEMENT = exports.CUSTOM_SURVEY = exports.ELIGIBILITY_DIALOG = exports.REPLY_TEXTS = exports.STATE_PROPERTY_NAMES = exports.BOT_DIALOG_NAMES = void 0;
exports.BOT_DIALOG_NAMES = {
...
exports.REPLY_TEXTS = {
    QUIT: 'quit',
    PROCESS_DISCARDED: "Process successfully cancelled. Even though I am not human, I do have a lot of answers to your queries, go on, challenge me. Just say 'Hi' to begin :)",
    CONVERSATION_END: {
        ASK_ME_MORE: [
    ...
    VALIDATE_BUTTONS: 'Sorry the click is allowed only for the latest option, kindly click on the buttons given above or click/type *Quit* to end the process.',
    GREETINGS: [
...
exports.ELIGIBILITY_DIALOG = {
    TEXT: 'You will have to apply for the Extended Flexible Work Option provided you meet the following criteria',
    BUTTONS: [{ display: 'Eligibility Criteria', value: 'extended_wfh_eligibility_criteria' }],
};
exports.CUSTOM_SURVEY = {
...
exports.LEAVE_MANAGEMENT = {
    ...
    LEAVE_MANAGEMENT_DIALOG: {
        UNABLE_TO_GET_USER_DETAILS_FROM_HR_MART: "I'm afraid I cannot get your details. Must be a technical glitch :(",
        ...
        USER_UNAVAILABLE_EMAIL_TO_DEV: "<font color='black'>This user is unavailable in our db/hr-mart: %s <br /><br /><br />Best Regards, <br />Ask ME</font>",
    },
    ...
    LEAVE_APPLY_DIALOG: {
        ...
        LEAVE_TO_DATE: {
            PROMPT: 'Almost there! Enter the To-Date of leave. (For eg: 1st Jan)\n\nOr click on quit to end the process',
            IF_FROM_DATE_AFTER_TO_DATE: 'The entered From-Date is after the To-Date. Kindly, re-apply with the appropriate dates.',
            BUTTONS: [{ display: 'Quit', value: 'quit' }],
        },
        LEAVE_TO_PERIOD: {
        ...
        LEAVE_HR_MART_APPLY: {
            LEAVES_EXHAUSTED: "Unfortunately You've exhausted your %s\n\nClick on the following to re-apply",
            SUCCESS_MESSAGE: 'Voila! Your %s request \n\nFrom-date: %s \n\nTo-date: %s \n\nhas been sent to your manager for approval.',
            ADDITIONAL_OPTION_PROMPT: 'If you wish to check your balance, cancel your applied leaves or apply for some more leaves -- Click on the following',
    ...
    LEAVE_CANCEL_DIALOG: {
        LIST_OF_PENDING_LEAVES: {
            ...
            PENDING_LEAVES: '*%s*\n\nLeave From: %s\n\nLeave To: %s\n\nRequested On: %s\n\nNo. of days: %s\n\nLeave Reason: %s\n\nStatus: %s',
            PROMPT: 'Click on the Request Id to cancel the applied leave.\n\nIn order to quit this process, click on the following:',
            BUTTONS: [{ display: 'Quit', value: 'quit' }],
        },
        CANCEL_REASON: {
            PROMPT: 'Please enter your reason for the cancellation.\n\n Or click on quit to end the process.',
            BUTTONS: [{ display: 'Quit', value: 'quit' }],
        },
        CANCEL_CONFIRMATION: {
            PROMPT: 'Are you sure you want to cancel the following leave: \n\nRequest ID: %s\n\nReason for cancellation: %s',
            BUTTONS: [
    ...
    LEAVE_APPROVE_DIALOG1: {
        ...
        LEAVE_SUMMARY_AND_MULTISELECT_PROMPT: 'Following is a multi-select list, click on \'Proceed\' after the selection.\n\n',
        REJECT_LEAVE_REMARK: {
...
exports.BYOD_AD_SERVICE_NOW = {
    ...
    BYOD_SERVICE_NOW_RESTART_DIALOG: {
        RAISE_REQUEST: {
            PROMPT: "Oops, you have entered an incorrect ID. Please click on the below button to enter the correct ID or Click on 'Quit' button to start a new conversation",
            BUTTONS: [
                {
...
exports.GREETING_BUTTONS_NOTIFICATIONS = [
    { display: 'Benefits', value: '#General#Benefits' },
    { display: 'Leave Management', value: '#Leave#LeaveManagement' },
    { display: 'COVID-19 Care', value: '#General#Covid_Care' },
    { display: 'Associate Tools', value: '#General#WM_Portals' },
